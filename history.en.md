# History
 ...
 - 4.0 (2024.3.7)
   ...
   * Many API improvements.
     ...
     * [Notification messages of `try-expand-tree-from-attached-child`](https://github.com/piroor/treestyletab/wiki/API-for-other-addons#suppress-unintentional-expansion-of-collapsed-tree-by-tst) now has an extra property `child` corresponding to the added child tab.
